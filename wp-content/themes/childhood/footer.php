...
<div class="reply">
    <div class="reply__body">
        ...
        <?php echo do_shortcode('[contact-form-7 id="155" title="Форма в поп-ап"]'); ?>
    </div>
</div>
<footer>
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="footer__social">
                    ...
                    <a href="<?php the_field('instalink')?>" class="footer__social-item">
                    ...
                    <a href="<?php the_field('fblink')?>" class="footer__social-item">
                    ...
                    <a href="<?php the_field('youtubelink')?>" class="footer__social-item">
                ...
                <div class="footer__contacts">
                    <div class="footer__contacts-item">
                        ...
                        <div class="footer__contacts-tel">
                            <a href="tel:+<?php the_field('number')?>">+<?php the_field('number',2)?></a>
                            <a href="tel:+<?php the_field('number2')?>">+<?php the_field('number2',2)?></a>
                        </div>
                    </div>
                    <div class="footer__contacts-item">
...
<?php wp_footer()?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAq50cK1pCfj3p9L_S6UpmNEhJuPHnc6A8"></script>
